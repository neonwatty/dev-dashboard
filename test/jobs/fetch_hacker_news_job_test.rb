...
class FetchHackerNewsJobTest < ActiveJob::TestCase
  ...
  test "should fetch and create posts from Hacker News API" do
    ...
    post1 = Post.find_by(source: 'hackernews', external_id: '33445566')
    ...
    post2 = Post.find_by(source: 'hackernews', external_id: '33445567')
  ...
  test "should filter stories by minimum score" do
    ...
    high_post = Post.find_by(source: 'hackernews', external_id: '33445569')
    low_post = Post.find_by(source: 'hackernews', external_id: '33445570')
  ...
  test "should filter stories by keywords when configured" do
    ...
    matching_post = Post.find_by(source: 'hackernews', external_id: '33445571')
    non_matching_post = Post.find_by(source: 'hackernews', external_id: '33445572')
  ...
  test "should handle different story types" do
    ...
    post = Post.find_by(source: 'hackernews', external_id: '33445573')
    assert_not_nil post
  ...
  test "should calculate priority score correctly" do
    ...
    high_post = Post.find_by(source: 'hackernews', external_id: '33445575')
    medium_post = Post.find_by(source: 'hackernews', external_id: '33445576')
    low_post = Post.find_by(source: 'hackernews', external_id: '33445577')
  ...
  test "should handle missing optional fields gracefully" do
    ...
    post = Post.find_by(source: 'hackernews', external_id: '33445578')
    assert_not_nil post
